    ...
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative bg-[#0a0e27] pt-32 pb-32 text-center px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
          ...
          >
            <Zap className="w-4 h-4 text-amber-400" /> Our Training
          </motion.div>
      ...
      <section className="pt-24 pb-12 text-center px-4 max-w-4xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <div className="text-sm font-bold tracking-widest text-[#3b82f6] uppercase mb-4">Our Training</div>
          ...
          return (
            <div key={block.id} className={`flex flex-col gap-12 md:gap-16 items-center ${isReversed ? 'md:flex-row-reverse' : 'md:flex-row'}`}>
              ...
              >
                ...
                <Link to={`/training/${block.slug}`} className="group inline-flex items-center gap-2 text-[#2563eb] font-bold text-sm hover:text-blue-700 transition-colors">
                  Explore Curriculum 
